...
# very lightly adapted by Zasha Weinberg
...
# added by Zasha, to convert everything to RNA
def dinuclShuffleUnnormalizedString (s):
  s=s.translate(str.maketrans('acgtT','ACGUU'))

  if re.match("[^ACGU]", s):
    raise AssertionError('caller gave non-RNA letter')

  return dinuclShuffle(s)
